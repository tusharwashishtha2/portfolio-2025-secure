                ...
                >
                    <div className="lg:col-span-7 space-y-10 order-2 lg:order-1">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-4">
                            ...
                            <a href="/assets/Tushar_2026.pdf" download="Tushar_2026.pdf" onClick={handleResumeDownload} className="group relative px-6 py-4 bg-[#06b6d4]/10 border border-[#06b6d4]/30 rounded-lg hover:bg-[#06b6d4]/20 transition-all flex items-center justify-center gap-3 overflow-hidden">
